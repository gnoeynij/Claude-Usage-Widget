...
- **알려진 빈 구멍** ([BACKLOG.md](BACKLOG.md) 참조):
  ...
  - macOS dmg 릴리즈 파이프라인 corruption — v2.5.0까지 CI 가 만든 `.dmg` 가 손상된 채 나왔을 가능성 (2026-08-10 실사용자 첫 설치 시도에서 발견). v2.5.1 에서 조치했으나 **실기기 재검증 전** — 회귀 사례 §23 참조.
