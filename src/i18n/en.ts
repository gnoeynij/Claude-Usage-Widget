export const en = {
  ...
  tokenExpiredHint: "The widget will try refreshing it via Claude Code. If this persists, run `claude` once.",
  ...
  copied: "Copied",
  clickThroughOn: "Click-through on",
  clickThroughOnHint: "The widget now ignores the mouse. Restore via tray right-click → \"Disable click-through\".",
