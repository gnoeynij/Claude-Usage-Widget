...
export const ko: Strings = {
  ...
  tokenExpiredHint: "위젯이 Claude Code로 자동 갱신을 시도해요. 계속되면 터미널에서 `claude` 를 실행해 주세요.",
  noCredentials: "인증 정보 없음",
  noCredentialsHint: "터미널에서 `claude` 를 실행해 로그인하면 동기화가 다시 시작돼요.",
  loginOpen: "로그인 열기",
  autoStart: "PC 시작 시 자동 실행",
  copied: "복사됨",
  clickThroughOn: "클릭 통과 켜짐",
  clickThroughOnHint: "위젯이 마우스를 통과시켜요. 트레이 우클릭 → \"클릭 통과 해제\"로 되돌릴 수 있어요.",
