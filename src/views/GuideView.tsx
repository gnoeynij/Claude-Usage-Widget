...
const CALLOUTS: Record<GuideMode, Callout[]> = {
  ...
  settings: [
    ...
    { anchor: "set-appearance", side: "left", y: 330,
      title: { en: "Appearance & startup", ko: "테마 · 항상 위 · 자동 실행" },
      desc: { en: "Pin above other windows, switch dark/light theme, or launch the widget automatically when your PC starts.", ko: "위젯을 다른 창 위에 고정하거나 다크/라이트 테마를 전환하고, PC 시작 시 자동 실행을 켤 수 있습니다." } },
